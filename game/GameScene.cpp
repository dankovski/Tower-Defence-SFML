...
int GameScene::run(sf::RenderWindow& mWindow) {
	...
	gameMenuText1.setCharacterSize(gameSize.y / 40.0);
	...
	gameMenuText2.setCharacterSize(gameSize.y / 40.0);
	gameMenuText2.setOutlineThickness(5);
	gameMenuText2.setOutlineColor(sf::Color::Black);
	gameMenuText2.setOrigin(gameMenuText2.getGlobalBounds().width / 2, gameMenuText2.getGlobalBounds().height / 2);
	gameMenuText2.setPosition(sf::Vector2f(gameSize.x * 0.5, gameSize.y * 0.45));


	gameMenuButtonLeft = Button(&font, "YES", sf::Vector2f(gameSize.x * 0.4, gameSize.y * 0.6), gameSize.y / 40.0, sf::Color::Yellow);
	gameMenuButtonRight = Button(&font, "NO", sf::Vector2f(gameSize.x * 0.6, gameSize.y * 0.6), gameSize.y / 40.0, sf::Color::Yellow);;
